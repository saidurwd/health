...
class ThanaController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('Thana');
    ...
    public function actionAdmin() {
        $model = new Thana('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['Thana']))
            $model->attributes = $_GET['Thana'];
     ...
     * @param Thana $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'thana-form') {
