...
class AclActionController extends Controller {
    ...
    public function accessRules() {
        return array(
            ...
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
                'actions' => array('create', 'update', 'admin', 'delete', 'actions', 'view'),
                'users' => array('@'),
            ),
            array('allow', // allow admin user to perform 'admin' and 'delete' actions
                'actions' => array('create', 'update', 'admin', 'delete', 'actions'),
                'users' => array('admin'),
            ),
    ...
    public function actionUpdate($id) {
        ...
        if (isset($_POST['AclAction'])) {
            $model->attributes = $_POST['AclAction'];
            if ($model->save()) {
                Yii::app()->user->setFlash('success', 'ACL action has been updated successfully');
                $this->redirect(array('view', 'id' => $model->id, 'cid' => $model->controller_id));
            }
        }
    ...
    public function actionIndex() {
        ...
        $dataProvider = new CActiveDataProvider('AclAction');
    ...
    public function actionAdmin() {
        $model = new AclAction('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['AclAction']))
            $model->attributes = $_GET['AclAction'];
    ...
    /**
     * Manages specific models.
     */
    public function actionActions() {
        $model = new AclAction('actions');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['AclAction']))
            $model->attributes = $_GET['AclAction'];
    ...
    public function loadModel($id) {
        $model = AclAction::model()->findByPk($id);
        if ($model === null)
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'acl-action-form') {
