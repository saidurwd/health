...
/* @var $model Store */
$this->pageTitle = 'Stores - ' . Yii::app()->name;
                    ...
                    <div class="widget-body no-padding">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'parent',
                                    'value' => 'Store::getData($data->parent,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'parent', CHtml::listData(Store::model()->findAll(array('condition' => 'parent IS NULL OR parent=0', 'order' => 'path')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                ...
                                array(
                                    ...
                                    'type' => 'raw',
                                    'value' => '$data->location',
                                    'filter' => CHtml::activeTextField($model, 'location', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'incharge',
                                    'type' => 'raw',
                                    'value' => 'User::get_full_name($data->incharge)',
                                    'filter' => CHtml::activeDropDownList($model, 'incharge', CHtml::listData(User::model()->findAll(array('condition' => '', 'order' => 'full_name')), 'id', 'full_name'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'description',
