...
/* @var $model Batch */
$this->pageTitle = 'Batches - ' . Yii::app()->name;
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'manufacturing',
                                    'type' => 'raw',
                                    'value' => '$data->manufacturing',
                                    'filter' => CHtml::activeTextField($model, 'manufacturing', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'expiry',
                                    'type' => 'raw',
                                    'value' => '$data->expiry',
                                    'filter' => CHtml::activeTextField($model, 'expiry', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'header' => 'Actions',
