                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'city_2_code',
                                    'type' => 'raw',
                                    'value' => '$data->city_2_code',
                                    'filter' => CHtml::activeTextField($model, 'city_2_code', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'city_3_code',
                                    'type' => 'raw',
                                    'value' => '$data->city_3_code',
                                    'filter' => CHtml::activeTextField($model, 'city_3_code', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
