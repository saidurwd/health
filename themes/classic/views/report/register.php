<?php
$this->pageTitle = 'Patient Register Medicine';
$this->breadcrumbs = array(
    'Reports' => array('register'),
    'Patient Register Medicine',
);
        ...
        <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false">
                <header>
                    ...
                    <h2>Patient Register Medicine</h2>
                </header>
                <!-- widget div-->
                <div>
                    <!-- widget content -->
                    <div class="widget-body">
                        ...
                        <div class="row">
                            ...
                            <section class="col col-1">
                                <?php echo CHtml::link('<i class="fa fa-print"></i> Print', array('registerprint', 'start_date' => $start_date, 'end_date' => $end_date, 'category' => $category, 'category_new' => $category_new), array('class' => 'btn btn-info btn-sm btn-block', 'target' => '_blank')); ?>
                            </section>
                        </div>
                        <?php $this->endWidget(); ?>
                        <table class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                <?php
                                $array = Report::patientRegisterReport($start_date, $end_date, $category, $category_new);
                                $total = count($array);
                                $i = 1;
