    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body custom-scroll load-po-scroll">
                ...
                $this->widget('zii.widgets.grid.CGridView', array(
                    ...
                    'columns' => array(
                        ...
                        array(
                            'type' => 'raw',
                            'value' => 'CHtml::link("<i class=\'fa fa-plus\'></i>","javascript:void(0)",array("class"=>"btn btn-primary btn-xs", "onclick"=>"addToPurchaseReceive($data->id,$_REQUEST[id])"))',
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-sm pull-left" id="add-selected" onclick="moveSelected(<?php echo $_REQUEST['id']; ?>);"><i class="fa fa-plus"></i> ADD SELECTED</button>
...
<script type="text/javascript">
    function addToPurchaseReceive(pono, prp)
    {
        $.ajax({
            type: 'GET',
            url: '<?php echo Yii::app()->createAbsoluteUrl("purchaseReceive/addpoupdate"); ?>',
            data: {id: pono, prp: prp},
    ...
    function moveSelected(prp) {
        ...
        if (selectedIDs != "")
        {
            $.ajax({
                type: "GET",
                url: "<?php echo $this->createUrl('purchaseReceive/addselectedpoupdate'); ?>",
                data: "selectedIDs=" + selectedIDs + "&prp=" + prp,
                cache: false,
                async: false,
