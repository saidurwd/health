...
$this->pageTitle = 'Departments - ' . Yii::app()->name;
                    ...
                    <div class="widget-body no-padding">
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'parent',
                                    'value' => 'Department::getData($data->parent,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'parent', CHtml::listData(Department::model()->findAll(array('condition' => 'parent IS NULL OR parent=0', 'order' => 'path')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
