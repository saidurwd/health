...
<fieldset>
    ...
    <div class="row">
        <section class="col col-6">
            ...
            <label class="input">
                <?php echo $form->textField($model, 'title', array('maxlength' => 150, 'class' => 'col-sm-12', 'placeholder' => 'State')); ?>
    ...
    <div class="row">
        <section class="col col-6">
            <label class="label"><?php echo $form->labelEx($model, 'state_2_code'); ?></label>
            <label class="input">
                <?php echo $form->textField($model, 'state_2_code', array('maxlength' => 2, 'class' => 'col-sm-12', 'placeholder' => 'Code 2')); ?>
                <?php echo $form->error($model, 'state_2_code'); ?>
            </label>
        </section>
    </div>
    <div class="row">
        <section class="col col-6">
            <label class="label"><?php echo $form->labelEx($model, 'state_3_code'); ?></label>
            <label class="input">
                <?php echo $form->textField($model, 'state_3_code', array('maxlength' => 3, 'class' => 'col-sm-12', 'placeholder' => 'Code 3')); ?>
                <?php echo $form->error($model, 'state_3_code'); ?>
            </label>
        </section>
    </div>
    <div class="row">
