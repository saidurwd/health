                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'state_2_code',
                                    'type' => 'raw',
                                    'value' => '$data->state_2_code',
                                    'filter' => CHtml::activeTextField($model, 'state_2_code', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'state_3_code',
                                    'type' => 'raw',
                                    'value' => '$data->state_3_code',
                                    'filter' => CHtml::activeTextField($model, 'state_3_code', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
