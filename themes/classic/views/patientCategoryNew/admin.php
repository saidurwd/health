<?php
/* @var $this PatientCategoryNewController */
/* @var $model PatientCategoryNew */

$this->pageTitle = 'Patient Categories - ' . Yii::app()->name;
$this->breadcrumbs = array(
    'Patient Categories' => array('admin'),
    'Manage',
);
                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'parent',
                                    'type' => 'raw',
                                    'value' => 'PatientCategoryNew::getData($data->parent,"title")',
                                    'filter' => CHtml::activeDropDownList($model, 'parent', CHtml::listData(PatientCategoryNew::model()->findAll(array('condition' => 'parent IS NULL', 'order' => 'title')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'title',
                                    'type' => 'raw',
                                    //'value' => '$data->title',
                                    'value' => 'PatientCategoryNew::get_full_path($data->id)',
