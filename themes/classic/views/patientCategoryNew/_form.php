        ...
        <div class="row">
            <section class="col col-6">
                <label class="select">
                    ...
                    <?php echo $form->dropDownList($model, 'parent', CHtml::listData(PatientCategoryNew::model()->findAll(array('condition' => 'parent IS NULL', 'order' => "title")), 'id', 'title'), array('empty' => 'Select a Parent', 'class' => 'select2')); ?>
