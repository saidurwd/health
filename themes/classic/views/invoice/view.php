...
$this->breadcrumbs = array(
    ...
    InvoiceParent::getData(@$_REQUEST['id'], "invoice_number"),
);
?>
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 text-right">   
        ...
        <?php echo CHtml::link('<span class="btn-label"><i class="fa fa-print"></i></span> PRINT', array('print', 'id' => @$_REQUEST['id']), array('target' => '_blank', 'class' => 'btn btn-labeled btn-info')); ?>
    </div>
</div>
<!-- widget grid -->
            ...
            <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false">
                ...
                <div>
                    ...
                    <div class="widget-body">
                        ...
                        ?>
                        <h3>Comments</h3>
                        <p><?php echo InvoiceParent::getData(@$_REQUEST['id'], 'comments'); ?></p>
                    </div>
                    <!-- end widget content -->
                </div>
                <!-- end widget div -->
