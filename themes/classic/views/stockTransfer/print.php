...
<?php $this->pageTitle = 'Stock Transfer'; ?>
<div class="widget-body no-padding">
    <div class="padding-10">
            ...
            <div class="col-sm-3">                
                <div>
                    <div>
                        ...
                        <span class="pull-right"> <?php echo TransectionStatus::getStatus($parent->status, 6); ?> </span>
                    </div>
                </div>
                <div>
                    <div>
                        <strong>TRANSFER NO :</strong>
                        <span class="pull-right"> <?php echo $parent->transfer_number; ?> </span>
                    </div>
                </div>
                <div>
                    <div class="font-md">
                        <strong>TRANSFER DATE :</strong>
                        <span class="pull-right"> <i class="fa fa-calendar"></i> <?php echo User::get_date($parent->transfer_date); ?> </span>
                    </div>
                </div>
                <br />
                <div class="well well-sm  bg-color-darken txt-color-white no-border">
                    <div class="fa-lg">
                        Total Amount :
                        <span class="pull-right"> <?php echo Product::number_format_currency(StockTransfer::getTotalAmount($parent->id), 2, Yii::app()->session->get('currency')); ?> </span>
                    </div>
                </div>
                <br />
            </div>
        ...
        $this->widget('zii.widgets.grid.CGridView', array(
            ...
            'dataProvider' => $model->searchTransfer($parent->id),
            ...
            <div class="row">
                ...
                <div class="col-sm-5">
                    <div class="invoice-sum-total pull-right">
                        <h3><strong>Total: <span class="text-success"><?php echo Product::number_format_currency(StockTransfer::getTotalAmount($parent->id), 2, Yii::app()->session->get('currency')); ?></span></strong></h3>
                    </div>
                </div>
            </div>
            <div class="row">
