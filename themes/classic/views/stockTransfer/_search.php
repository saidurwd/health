    ...
    <div class="row">
        <section class="col col-2">
            <label class="input">
                ...
                <?php echo $form->textField($model, 'transfer_number', array('size' => 60, 'maxlength' => 250, 'class' => 'col-sm-12', 'placeholder' => 'Transfer #')); ?>
                <?php echo $form->error($model, 'transfer_number'); ?>
            </label>
        </section>
        <section class="col col-2">
            <label class="select">
