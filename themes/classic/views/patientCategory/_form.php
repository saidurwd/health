<?php
/* @var $this PatientCategoryController */
/* @var $model PatientCategory */
    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-6">
                <label class="select">
                    ...
                    <?php echo $form->dropDownList($model, 'parent', CHtml::listData(PatientCategory::model()->findAll(array('condition' => 'parent IS NULL', 'order' => "title")), 'id', 'title'), array('empty' => 'Select a Parent', 'class' => 'select2')); ?>
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="input">
                    <?php echo $form->textField($model, 'title', array('maxlength' => 150, 'class' => 'col-sm-12', 'placeholder' => 'Sub Category')); ?>
