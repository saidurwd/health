                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                ...
                                array(
                                    'name' => 'country_2_code',
                                    'type' => 'raw',
                                    'value' => '$data->country_2_code',
                                    'filter' => CHtml::activeTextField($model, 'country_2_code', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'country_3_code',
                                    'type' => 'raw',
                                    'value' => '$data->country_3_code',
                                    'filter' => CHtml::activeTextField($model, 'country_3_code', array('class' => 'form-control')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'status',
