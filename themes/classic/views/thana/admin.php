                        ...
                        $this->widget('zii.widgets.grid.CGridView', array(
                            ...
                            'columns' => array(
                                array(
                                    'name' => 'country',
                                    'type' => 'raw',
                                    'value' => '$data->country0->title',
                                    'filter' => CHtml::activeDropDownList($model, 'country', CHtml::listData(Country::model()->findAll(array('condition' => '', 'order' => 'title')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'state',
                                    'type' => 'raw',
                                    'value' => '$data->state0->title',
                                    'filter' => CHtml::activeDropDownList($model, 'state', CHtml::listData(State::model()->findAll(array('condition' => '', 'order' => 'title')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'city',
                                    'type' => 'raw',
                                    'value' => '$data->city0->title',
                                    'filter' => CHtml::activeDropDownList($model, 'city', CHtml::listData(City::model()->findAll(array('condition' => '', 'order' => 'title')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'district',
                                    'type' => 'raw',
                                    'value' => '$data->district0->title',
                                    'filter' => CHtml::activeDropDownList($model, 'district', CHtml::listData(District::model()->findAll(array('condition' => '', 'order' => 'title')), 'id', 'title'), array('empty' => 'All', 'class' => 'select2')),
                                    'htmlOptions' => array('class' => ''),
                                ),
                                array(
                                    'name' => 'title',
