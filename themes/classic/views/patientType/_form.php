<?php
/* @var $this PatientTypeController */
/* @var $model PatientType */
    ...
    <fieldset>
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="input">
                    <?php echo $form->textField($model, 'title', array('maxlength' => 250, 'class' => 'col-sm-12', 'placeholder' => 'Patient Type')); ?>
        ...
        <div class="row">
            <section class="col col-6">
                ...
                <label class="input">
                    <?php echo $form->textField($model, 'remarks', array('maxlength' => 400, 'class' => 'col-sm-12', 'placeholder' => 'Remarks')); ?>
